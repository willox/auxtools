...
signatures! {
	...
	call_datum_proc_by_name => version_dependent_signature!(
		..1606 => "55 89 E5 57 56 53 83 EC ?? 8B 45 20 0F B6 55 14 8B 7D 1C 8B 5D 0C 89 45 B4 8D 45 ?? 8B 75 ?? 89 44 24 08 8B 45 B4 0F B6 CA 89 4D BC 31 C9 88 55 BB 8B 55 18 C6 45 E7 ?? 89 44 24 04 8B 45 BC C7 44 24 0C 01 ?? ?? ?? 89 3C 24",
	...
	get_assoc_element => version_dependent_signature!(
		..1606 => "55 89 E5 83 EC ?? ?? ?? ?? ?? 5D F4 89 D3 89 75 F8 89 D6 89 7D FC 89 CF 89 45 B4 0F 84 B7 00 00 ??",
		1606.. => "55 89 E5 83 EC ?? 89 4D ?? B9 7B 00 00 00 89 5D ?? 89 D3 89 75 ?? 89 C6"
	),

	set_assoc_element => version_dependent_signature!(
		..1606 => "55 89 E5 83 EC 68 89 75 F8 8B 75 08 89 5D F4 89 C3 8B 45 0C 89 7D FC 80 FB 3C 89 D7 88 5D BF 89 ??",
		1606.. => "55 B9 7C 00 00 00 89 E5 83 EC 58 89 7D ?? 8B 7D ?? 89 5D ?? 89 C3 8B 45 ??"
	),
	...
	to_string => version_dependent_signature!(
		1606.. => "55 89 E5 83 EC 68 89 5D F4 8D 5D C8 89 75 F8 89 ??",
		1560..1606 => (call, "E8 ?? ?? ?? ?? 89 04 24 E8 ?? ?? ?? ?? 8B 00 8D 4D ?? 89 0C 24"),
