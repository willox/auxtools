...
impl From<f32> for Value {
	fn from(num: f32) -> Self {
		unsafe { Value::new(raw_types::values::ValueTag::Number, raw_types::values::ValueData { number: num }) }
	}
}

impl From<i32> for Value {
	fn from(num: i32) -> Self {
		unsafe { Value::new(raw_types::values::ValueTag::Number, raw_types::values::ValueData { number: num as f32 }) }
	}
}
...
impl From<bool> for Value {
	fn from(b: bool) -> Self {
		unsafe {
			Value::new(raw_types::values::ValueTag::Number, raw_types::values::ValueData {
...
// The blanket implementation of TryFrom in core conflicts with -any- generics
// on a TryFrom trait
//
